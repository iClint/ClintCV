...
export const AboutTickerConfig: AboutTickerConfigModel = {
  ...
  items: [
    ...
    'If your feature doesn’t work in dark mode, did it ever really work?',
...
export const AboutPageContent: AboutContentModel = {
  aboutMe: {
    ...
    content: `I'm Clint: a fullstack engineer, ex-armored car operator, and
  ...
  howIGotHere: {
    ...
    list: [
      `Early 1990s: wrote BASIC on an IBM-compatible 8086 beige box.`,
      `Ran a Cash-in-Transit business for 10+ years (yes, with guns and armored vehicles).`,
      `Accident recovery and a global pandemic added up to the weirdest pivot into tech you’ll ever hear.`,
    ],
  },
  profesionalJourney: {
    ...
    list: [
      ...
      `Joined Woolworths Online, where I learned the art of customer chaos (I
          mean service).`,
      `Built a portfolio and landed a spot in the WooliesX fullstack pilot tech
          accelerator program (12 out of 100+ candidates).`,
      `Smashed a 12-week bootcamp and earned my first dev gig.`,
      `Joined WooliesX in the Fulfilment domain as a core contributor to the Order Tracking Portal.`,
      ...
      `Keen to take on new challenges and keep pushing my skills further.`,
    ],
  },
  outsideOfWork: {
    title: 'Outside of Work',
    content: `When I’m not coding, you’ll find me tinkering with hardware, flying helicopters in MSFS inside a VR headset, messing with my home lab, paddle boarding, or teaching myself something new. I’m also a big fan of coffee, and I’m not above using it as a performance-enhancing drug.`,
  },
};
